...
blade pitch range is -2° to +10°. Fully aerobatic setups would use -12° to +12°. For initial tests, the narrower range is recommended.
...
which may be too sensitive for some pilots. Therefore, for those setups, it is recommended to change the values from default values to something like this:
...
to provide a similar curve in STABILIZE to that of the narrower collective range. At least until the pilot becomes accustomed to the collective feel.
