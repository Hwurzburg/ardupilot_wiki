...
* :ref:`BATT_VOLT_PIN<BATT_VOLT_PIN>` = 19
* :ref:`BATT_CURR_PIN<BATT_CURR_PIN>` = 9
...
* :ref:`BATT2_VOLT_MULT<BATT2_VOLT_MULT>` = 34
* :ref:`BATT2_AMP_PERVLT<BATT2_AMP_PERVLT>` should be set as required by the specific monitor used
