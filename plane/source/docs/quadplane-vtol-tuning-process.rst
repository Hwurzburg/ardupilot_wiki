...
used to maintain yaw hold intead of providing lift. This can be caused by:
...
and you may not see a problem until you yaw the plane left and right
to test this.
...
airframe to resist twisting,making sure prop flow is unbostructed by the wings on TVBS frames,or correcting/adjusting motor tilt angles
